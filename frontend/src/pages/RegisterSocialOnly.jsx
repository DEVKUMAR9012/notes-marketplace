      ...
      >
        <div className="bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/10">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-white">Join Notes Marketplace</h1>
            <p className="text-gray-400 mt-3 text-sm">Sign up to start learning & sharing</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-white/10 text-center">
            <p className="text-gray-400 text-sm">
              Already have an account? <span className="text-gray-500">Use login with any method</span>
            </p>
          </div>
        </div>
      </motion.div>
